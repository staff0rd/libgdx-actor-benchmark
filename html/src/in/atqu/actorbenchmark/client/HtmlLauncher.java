package in.atqu.actorbenchmark.client;
...
public class HtmlLauncher extends GwtApplication {
        ...
        native void setupResizeHook() /*-{
                var htmlLauncher_onWindowResize = $entry(@in.atqu.actorbenchmark.client.HtmlLauncher::handleResize());
